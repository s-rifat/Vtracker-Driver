    ...
    private void loadUserList() {
        ...
        adapter = new FirebaseRecyclerAdapter<User, UserViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull UserViewHolder holder, int position, @NonNull final User model) {
                   if(model.getEmail().equals(Common.loggedDriver.getEmail()))
                   {
           ...
           alertDialog.setPositiveButton("SEND", new DialogInterface.OnClickListener() {
               ...
               public void onClick(DialogInterface dialogInterface, int i) {
                   ...
                   DatabaseReference acceptList = FirebaseDatabase.getInstance()
                           .getReference(Common.Driver_INFORMATION)
                           .child(Common.loggedDriver.getUid())
       ...
       private void sendFriendRequest(final User model) {
        //get token to send
           DatabaseReference tokens = FirebaseDatabase.getInstance().getReference(Common.Driver_TOKENS);
                   ...
                   .addListenerForSingleValueEvent(new ValueEventListener() {
                       ...
                       public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                           ...
                           else
                           {
                               ...
                               dataSend.put(Common.FROM_UID,Common.loggedDriver.getUid());
                               dataSend.put(Common.FROM_NAME,Common.loggedDriver.getEmail());
