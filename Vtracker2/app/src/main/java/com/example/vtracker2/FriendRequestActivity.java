...
public class FriendRequestActivity extends AppCompatActivity implements IFirebaseLoadDone {
    ...
    private void addUserToFriendContact(User model) {
        ...
        acceptList.child(model.getUid()).setValue(Common.loggedDriver);
    }
    ...
    private void loadSearchData() {
        ...
        DatabaseReference userList = FirebaseDatabase.getInstance().getReference().child(Common.Driver_INFORMATION)
                .child(Common.loggedDriver.getUid())
                .child(Common.FRIEND_REQUEST);
