...
public class MyLocationReciever extends BroadcastReceiver {
    ...
    public MyLocationReciever() {
        ...
        publicLocation = FirebaseDatabase.getInstance().getReference(Common.Driver_LOCATION);
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        uid = Paper.book().read(Common.Driver_UID_SAVE_KEY);
        if(intent!=null)
        {
            ...
            if(action.equals(ACTION))
            {
                ...
                if(result!=null)
                {
                    ...
                    if(Common.loggedDriver!=null)//app in foreground
                    {
                        publicLocation.child(Common.loggedDriver.getUid()).setValue(location);
                    }
                    else //app be killed
                    {
